...
%----------------------------------------------------------------------------
	...
	%----------------------------------------------------------------------------
		...
		A CPU-s modellek eredményei teljes mértékben megegyeztek. Eltérés elõször a CPU-s és GPU-s megoldások között mutatkozott, melynek oka a lebegõpontos számítások hardveres megvalósításában keresendõ \cite{CUDAFloat}.
