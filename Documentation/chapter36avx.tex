...
void NBodyAlgorithmCPU::calculateAcceleration(const float3(&posI)[8],
	...
	// Gyorsulásértékékek visszamásolása a megadott float tömbbe (x,...,x,y,...,y,z,...,z) formában
	...
	%----------------------------------------------------------------------------
		...
		Sajnos idõm nem maradt a félév végére, hogy profiler segítségével a cache miss-t igazolni tudjam.
