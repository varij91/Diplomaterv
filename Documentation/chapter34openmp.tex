...
\section{OpenMP}
%----------------------------------------------------------------------------
	Elsõ lépésben az egyik legegyszerûbben elérhetõ és relatíve kevés munkát igénylõ OpenMP felhasználásával igyekeztem a munkát szétosztani szálak között. Kiválóan alkalmazható olyan problémák esetén, ahol a párhuzamosítandó részek mérete futási idõben dõl el.

	Az OpenMP (Open Multi-Processing) egy specifikáció, a kiegészítése a C és C++ nyelveknek, mely már igen széleskörû támogatottságot élvez a nagy hardver- és szoftvergyártók részérõl. 
