...
%----------------------------------------------------------------------------
	...
	A MATLAB prototípus futási eredményeit nem ábrázoltam, mert szkriptnyelvrõl lévén szó nagyságrendekkel kisebb teljesítményt produkált, így lényegében nem is látszódna a grafikonon.
	...
	%----------------------------------------------------------------------------
		...
		A második részben látható a kezdeti adatok átmásolása az eszköz memóriájába majd a kernel futása összesen 20-szor. Minden iteráció után megtörténik a meghatározott adatok visszamásolása a rendszermemóriába. A legvégén pedig az alaphelyzetbe állító függvény a \verb+cudaDeviceReset+ fut le.
		...
		\end{quote}
		Az analízis során kiderült, hogy a vezérlõ (control-flow) jellegû utasítások aránya viszonylag magas, a ,,hasznos'' aritmetikai utasításokhoz képest. Az arányokat az \figref{Perf_utilization} ábra mutatja.
