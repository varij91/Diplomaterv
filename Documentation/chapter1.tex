...
%----------------------------------------------------------------------------
	...
	%----------------------------------------------------------------------------
		...
		%----------------------------------------------------------------------------
			...
			Megjegyzendõ, hogy a korábban feltett $j \neq i$ a továbbiakban nem szükséges, ugyanis $F_{ii}=0$, ha $\varepsilon^2 > 0$. Bár elsõ ránézésre feleslegesnek tûnik elvégezni a számításokat $j=i$ esetben, azonban SIMD jellegû adatfeldolgozás esetén érdemes elkerülni az elágazó utasításokat a hatékonyság érdekében~\cite{GPUGems}.
