...
void main() {
	...
	cudaFree(d_c);
			...
			Ha kevés adatot akarsz feldolgozni, akkor nem biztos, hogy megéri GPU-t használni. A szálak száma amivel érdemes más GPU-t használni legyen körülbelül $1000$-res nagyságrendben.
